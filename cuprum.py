...
#setting page layout and heading
st.set_page_config(layout="wide")
st.write("""
<div style='text-align:center'>
    <h1 style='color:#F7EF8A;'>Industrial Copper Data Predictor</h1>
</div>
""", unsafe_allow_html=True)

#defining tabs
tab1, tab2,tab3 = st.tabs(["PREDICT SELLING PRICE", "PREDICT STATUS","ABOUT"]) 

#creating tab for regression
with tab1:    
        

        # defining possible values for the dropdown menus
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write('<h5 style="color:rgba(247, 239, 138, 0.4);">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True)
        ...
        if submit_button and flag==0:
            ...
            with open(r"C:\\Users\\devli\\copper\\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\\Users\\devli\\copper\\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\\Users\\devli\\copper\\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\\Users\\devli\\copper\\s.pkl", 'rb') as f:
...
#creating tab for classification           
with tab2: 
        ...
        if csubmit_button and cflag==0:
            ...
            with open(r"C:\\Users\\devli\\copper\\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'C:\\Users\\devli\\copper\\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\\Users\\devli\\copper\\ct.pkl", 'rb') as f:
...
with tab3:
     ...
     st.markdown('Domain: Mining and manufacturing')
     st.markdown("Inspired by sales prediction machine learning models")
